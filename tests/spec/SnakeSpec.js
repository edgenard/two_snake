describe("Snake", function () {
  ...
  it("moves East",function(){
    this.snake.move();
    expect(this.snake._segments).toEqual([[0, 1],[0,2]]);
  ...
  it("moves South", function () {
    this.snake._dir = "S";
    this.snake.move();
    expect(this.snake._segments).toEqual([[0, 1], [1,1]]);
  });
  ...
  it("moves West", function() {
    this.snake._dir = "W";
    this.snake.move();
    expect(this.snake._segments).toEqual([[0,1], [0,0]]);
  });
  ...
  describe("growing snake", function () {
    it("grows", function () {
      ...
      expect(this.snake._segments).toEqual([[0,0], [0, 1], [0, 2]]);
    });
  });
