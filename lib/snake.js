(function () {
  ...
  snake.prototype.validDirection = function(direction) {
    ...
    if (this._body._dir === "S" && (direction === "up" || direction === "w")){
      return false;
    }

    if (this._body._dir === "N" && (direction === "down" || direction === "s")){
      return false;
    }

    if (this._body._dir === "W" && (direction === "right" || direction === "d")){
      return false;
    }

    if (this._body._dir === "E" && (direction === "left" || direction === "a")){
      return false;
    }
  ...
  snake.prototype.headDup = function () {
    return dup(this._body.head());
  };

  snake.prototype.head = function () {
    return this._body.head();
  };

  snake.prototype.bodyNoHead = function () {
    var dup_body = dup(this.position());
    dup_body.pop();
    return dup_body ;
  };
